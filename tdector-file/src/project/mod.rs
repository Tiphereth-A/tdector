...
///
/// Handles all serialization concerns including format versioning and migration. Project files use a v2 format with space-optimized vocabulary storage:
...
pub use importer::{load_project_from_json, try_convert_from_saved_project_v2};
