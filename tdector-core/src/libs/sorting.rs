...
impl SortOperation {
    /// Sort segment indices in-place according to the specified sort mode. Handles multiple sort fields (Index, Original text, Length, Count, `TranslatedRatio`, `TranslatedCount`) and sort directions (Ascending/Descending).
